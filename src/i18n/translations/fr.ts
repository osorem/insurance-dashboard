const frJSON = {
  ...
  'Insurance Analytics':
    "Tableau de bord d'administration de Insurance Analytics React",
  ...
  'Some of the features that make Insurance Analytics one of the best admin templates available today':
    "Certaines des fonctionnalités qui font de Insurance Analytics l'un des meilleurs modèles d'administration disponibles aujourd'hui",
